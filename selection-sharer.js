  ...
  var SelectionSharer = function(options) {
    ...
    this.render = function() {
      var popoverHTML =  '<div class="selectionSharer" id="selectionSharerPopover" style="position:absolute;">'
                       ...
                       + '      <li><a class="action idea" href="" title="Save this Idea" target="_blank"></a></li>'
      ...
      self.$popover.find('a.idea').click(self.saveIdea);
      ...
      self.$popunder.find('a.idea').click(self.saveIdea);
      self.$popunder.find('a.email').click(self.shareEmail);
      $('body').append(self.$popunder);

      if (self.appId && self.url2share){
        $(".selectionSharer a.idea").css('display','inline-block');
      }
    };
